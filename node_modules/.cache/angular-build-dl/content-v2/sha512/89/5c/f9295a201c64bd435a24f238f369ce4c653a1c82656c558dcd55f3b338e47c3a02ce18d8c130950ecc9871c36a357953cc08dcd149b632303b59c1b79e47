(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-convert-image-convert-image-module"], {
    ...
    /***/
    function G5Jg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ConvertImageComponent", function () {
        return ConvertImageComponent;
      });
      /* harmony import */
      ...
      var ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ngx-dropzone-wrapper */
      "YpNe");

      var ConvertImageComponent = /*#__PURE__*/function () {
        function ConvertImageComponent() {
          _classCallCheck(this, ConvertImageComponent);
        ...
        _createClass(ConvertImageComponent, [{
          key: "onUploadInit",
          ...
          key: "downloadPattern",
          value: function downloadPattern() {
            var patternString = localStorage.getItem('markerUrl');
            ...
            THREEx.ArPatternFile.triggerDownload = function (patternFileString) {
              var fileName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'pattern-marker.patt';
              // tech from https://stackoverflow.com/questions/3665115/create-a-file-in-memory-for-user-to-download-not-through-server
              var domElement = window.document.createElement('a');
              domElement.href = window.URL.createObjectURL(new Blob([patternFileString], {
                type: 'text/plain'
              }));
          ...
          key: "updateFullMarkerImage",
          value: function updateFullMarkerImage() {
            ...
            THREEx.ArPatternFile.encodeImage = function (image) {
              ...
              for (var orientation = 0; orientation > -2 * Math.PI; orientation -= Math.PI / 2) {
                ...
                context.restore(); // get imageData

                var imageData = context.getImageData(0, 0, canvas.width, canvas.height); // generate the patternFileString for this orientation
            ...
            THREEx.ArPatternFile.buildFullMarker = function (innerImageURL, pattRatio, size, color, onComplete) {
              var whiteMargin = 0.1;
              var blackMargin = (1 - 2 * whiteMargin) * ((1 - pattRatio) / 2); // var blackMargin = 0.2
              ...
              context.fillRect(0, 0, canvas.width, canvas.height); // copy image on canvas

              context.fillStyle = color;
              context.fillRect(whiteMargin * canvas.width, whiteMargin * canvas.height, canvas.width * (1 - 2 * whiteMargin), canvas.height * (1 - 2 * whiteMargin)); // clear the area for innerImage (in case of transparent image)

              context.fillStyle = 'white';
              context.fillRect(innerMargin * canvas.width, innerMargin * canvas.height, canvas.width * (1 - 2 * innerMargin), canvas.height * (1 - 2 * innerMargin)); // display innerImage in the middle
            ...
            THREEx.ArPatternFile.buildFullMarker(this.innerImageURL, 0.50, 512, "black", function onComplete(markerUrl) {
              ...
              fullMarkerImage.src = markerUrl; // put fullMarkerImage into #imageContainer
      ...
      ConvertImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ConvertImageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("error", function ConvertImageComponent_Template_div_error_22_listener($event) {
              return ctx.onUploadError($event);
            })("success", function ConvertImageComponent_Template_div_success_22_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ConvertImageComponent_Template_button_click_54_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ConvertImageComponent_Template_button_click_60_listener() {
              return ctx.downloadImage();
            });
        ...
        directives: [ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_1__["DropzoneDirective"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ConvertImageComponent, [{
    ...
    /***/
    function lagP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ConvertImageRoutingModule", function () {
        return ConvertImageRoutingModule;
      });
      /* harmony import */
      ...
      var _convert_image_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ConvertImageRoutingModule = function ConvertImageRoutingModule() {
        _classCallCheck(this, ConvertImageRoutingModule);
      };

      ConvertImageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ConvertImageRoutingModule
      });
      ConvertImageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ConvertImageRoutingModule_Factory(t) {
          return new (t || ConvertImageRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ConvertImageRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ConvertImageRoutingModule, [{
    ...
    /***/
    function vNh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ConvertImageModule", function () {
        return ConvertImageModule;
      });
      /* harmony import */
      ...
      var _convert_image_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./convert-image-routing.module */
      "lagP");
      /* harmony import */


      var ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ngx-dropzone-wrapper */
      "YpNe");
      /* harmony import */


      var _convert_image_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./convert-image.component */
      "G5Jg");
      /* harmony import */
      ...
      var ConvertImageModule = function ConvertImageModule() {
        _classCallCheck(this, ConvertImageModule);
      };

      ConvertImageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ConvertImageModule
      });
      ConvertImageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ConvertImageModule_Factory(t) {
          return new (t || ConvertImageModule)();
        },
        providers: [{
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _convert_image_routing_module__WEBPACK_IMPORTED_MODULE_2__["ConvertImageRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_3__["DropzoneModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ConvertImageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ConvertImageModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
            declarations: [_convert_image_component__WEBPACK_IMPORTED_MODULE_4__["ConvertImageComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _convert_image_routing_module__WEBPACK_IMPORTED_MODULE_2__["ConvertImageRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_3__["DropzoneModule"]],
...
//# sourceMappingURL=components-convert-image-convert-image-module-es5.js.map